        ...
        <section className="py-10 bg-gray-50 sm:py-16 lg:py-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-transparent text-black sm:text-4xl lg:text-5xl bg-gradient-to-r from-rose-700 to-amber-600 bg-clip-text">Frequently Asked Questions</h2>
