            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="text-center">
                        <h2 className="mt-4 text-3xl font-bold text-transparent text-gray-900 sm:text-4xl xl:text-5xl font-pj bg-gradient-to-r from-rose-700 to-amber-600 bg-clip-text">Testimonials and Feedback</h2>
