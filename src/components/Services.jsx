...
const Services = () => {        
    return (
        <section className="py-12 bg-white sm:py-16 lg:py-20 bg-gradient-to-r from-sky-500 via-cyan-500 to-teal-500">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Enhancing Every Experience</h2>
                    <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Experience our exceptional services designed to elevate your stay.</p>
                </div>
                ...
                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div className="md:p-8 lg:p-14">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Free Wifi</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Stay connected with complimentary high-speed internet access.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Subtle Services</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Experience discreet and attentive service tailored to your needs.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Bar</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Unwind with your favorite drink at our inviting bar.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Restaurant</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Indulge in a culinary journey with our delicious cuisine.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        <svg className="mx-auto" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M18.5117 7C13.9517 7 10 10.9275 10 15.75C10 22.3125 20.5117 34.3975 20.5117 34.3975C20.7457 34.6168 21.0566 34.7297 21.3555 34.7297C21.6545 34.7297 21.9654 34.6168 22.1994 34.3975C22.1994 34.3975 32.6911 22.3125 32.6911 15.75C32.6911 10.9275 28.7394 7 24.1794 7H18.5117Z"
                                fill="#D4D4D8"
                            />
                            <path d="M21 1H25V6H21V1Z" fill="#D4D4D8" />
                        </svg>
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Fitness</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Stay active with our modern fitness center.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Pool</h3>
                        <p className="mt-5 text-base text-gray-600 font-pj">Relax by the poolside and soak up the sun.</p>
                    </div>
                </div>
            </div>
        </section>
