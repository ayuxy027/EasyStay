        ...
        <section className="py-12 bg-white sm:py-16 lg:py-20 ">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold leading-tight text-transparent text-gray-900 sm:text-4xl xl:text-5xl font-pj bg-gradient-to-r from-rose-700 to-amber-600 bg-clip-text">Services</h2>
