    ...
    <div className="bg-white">
      <div className="max-w-5xl px-4 py-10 mx-auto xl:px-0 lg:py-20">
        <div className="max-w-3xl mb-10 lg:mb-14">
          <h2 className="text-2xl font-semibold text-black md:text-4xl md:leading-tight">Contact Us</h2>
          <p className="mt-1 text-gray-600">We're here to assist you with your stay.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
          <div className="pb-10 mb-10 border-b border-gray-300 md:order-2 md:border-b-0 md:pb-0 md:mb-0">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-2">
                ...
                <p className="mt-5">
                  <button
                    type="submit"
                    className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-gray-800 rounded-full group gap-x-2 focus:outline-none"
                  >
                    Submit
                    <svg
          ...
          <div className="space-y-14">
            <div className="flex gap-x-5">
              <svg className="flex-shrink-0 text-gray-800 h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
